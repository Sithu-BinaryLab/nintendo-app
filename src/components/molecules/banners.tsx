		...
		<div className="w-full">
			...
			<div className="flex justify-center gap-4 mb-10">
				{images.map((src, index) => (
					<div
						key={index}
						className="relative overflow-hidden w-14 h-14 md:w-20 md:h-20 rounded-xl cursor-pointer"
					...
					>
						...
						{index === activeIndex && (
							<div
								className={`border-progress active ${index === images.length - 1 ? "border-goldenrod" : ""}`}
							>
