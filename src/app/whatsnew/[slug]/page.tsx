      ...
      <section className="w-full bg-white mx-auto mt-10">
        ...
        <div className="w-full  bg-gray-100 my-10 py-10">
          <div className="max-w-3xl p-4 mx-auto">
            ...
            <div>
              Did you know? Active{" "}
              <RedUnderline text="Nintendo Switch Online" />
            ...
            <p className="py-4">
              Without further ado, let’s dive into what’s new with Nintendo
              Switch Online.
            </p>
            <div className="mb-4">
            ...
            <div className="mb-4">
              ...
              <p>
                Use cunning strategy and guide your troops to victory in the
                Fire Emblem™: The Sacred Stones game, available now in the{" "}
                <RedUnderline
                  text="Game Boy™
              Advance"
                />{" "}
